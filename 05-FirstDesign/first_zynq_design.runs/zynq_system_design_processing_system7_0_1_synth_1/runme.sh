...
HD_PWD='F:/SOC/PYNQ-Z2/Project/05-FirstDesign/first_zynq_design.runs/zynq_system_design_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_system_design_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_system_design_processing_system7_0_1.tcl
