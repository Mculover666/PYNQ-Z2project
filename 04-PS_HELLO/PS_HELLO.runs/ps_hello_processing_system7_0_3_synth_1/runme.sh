...
HD_PWD='F:/SOC/PYNQ-Z2/Project/04-PS_HELLO/PS_HELLO.runs/ps_hello_processing_system7_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_hello_processing_system7_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_hello_processing_system7_0_3.tcl
