...
HD_PWD='F:/SOC/PYNQ-Z2/Project/04-PS_HELLO/PS_HELLO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_hello_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_hello_wrapper.tcl -notrace
